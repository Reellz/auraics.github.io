...
const missionVisionCards = document.querySelectorAll(
...
if (curriculumSection) {
  const curriculumObserver = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        entry.target.querySelector(".curriculum-text").style.transform =
          "translateX(0)";
        entry.target.querySelector(".curriculum-image").style.opacity = "1";
        entry.target.querySelector(".curriculum-image").style.transform =
          "translateX(0)";
      }
    });
  }, observerOptions);
  ...
  curriculumSection.querySelector(".curriculum-text").style.transform =
    "translateX(-20px)";
  curriculumSection.querySelector(".curriculum-text").style.transition =
    "all 0.6s ease-out";

  curriculumSection.querySelector(".curriculum-image").style.opacity = "0";
  curriculumSection.querySelector(".curriculum-image").style.transform =
    "translateX(20px)";
  curriculumSection.querySelector(".curriculum-image").style.transition =
    "all 0.6s ease-out";
...
form.addEventListener('submit', function(e) {
    ...
    .catch(error => {
        responseMsg.innerHTML = "Error: Could not connect to server.";
    });
});
